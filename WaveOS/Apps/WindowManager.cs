...
namespace WaveOS.Apps
{
    public class WindowManager : WaveGUIApp
    {
        ...
        public Graphics.Color desktopColor = new WaveOS.Graphics.Color((byte)WaveShell.rnd.Next(255), (byte)WaveShell.rnd.Next(255), (byte)WaveShell.rnd.Next(255));
        ...
        public override void Initialize()
        {
            ...
            OpenWindow(new WaveTaskbar(0, Canv.Height - 28, Canv.Width, 28, this));
        }
        ...
        public override int Run()
        {
            if (KeyboardManager.TryReadKey(out KeyEvent k))
            {
                ...
                {
                    desktopColor = new WaveOS.Graphics.Color((byte)WaveShell.rnd.Next(255), (byte)WaveShell.rnd.Next(255), (byte)WaveShell.rnd.Next(255));
                }
            ...
            Canv.DrawBitmap((int)Mouse.X, (int)Mouse.Y, pointerImg);
